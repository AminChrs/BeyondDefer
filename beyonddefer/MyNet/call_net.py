...
from beyonddefer.human_ai_defer.networks.cnn import WideResNet
from beyonddefer.human_ai_defer.baselines.selective_prediction import\
     SelectivePrediction
from beyonddefer.human_ai_defer.networks.cnn import NetSimple
from beyonddefer.human_ai_defer.networks.cnn import DenseNet121_CE
from beyonddefer.human_ai_defer.networks.linear_net import LinearNet
import os
import numpy as np
import logging
...
def networks(dataset_name, method, device, **kwargs):
    ...
    if dataset_name == "cifar_synth":
        ...
        if method == "CompConfMeta":
            ...
            return model
    if dataset_name == "cifar_synth_netsimple":
        if method == "BD":
